...
if __name__ == '__main__':
    ...
    all_txt_files = ["RA8.0_RT1.0_CL0.5_hbchange_cp1D5T_init0_LLsolvernonlinear_didistquadratic_grid100_optmethodSLSQP_dibounds(-90, 90)_opttol1e-12_optmaxiter1000_cases1.txt",
    ...
    for file_name in all_txt_files:
        ...
        if "1D5T" in file_name:
            hello = opt_data[15:21]
        else:
        ...
        cdi.plot(y_b, z_b, color="black", linewidth=plot_linewidth, linestyle=linestyle_list[count], label=label_names[count])
        count+=1

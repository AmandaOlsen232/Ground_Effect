...
if __name__=="__main__":
    ...
    all_txt_files = ["RA8.0_RT1.0_CL0.5_hbchange_cp1D5T_init0_LLsolvernonlinear_didistquadratic_grid100_optmethodSLSQP_dibounds(-90, 90)_opttol1e-12_optmaxiter1000_cases100.txt",
    ...
    for file_name in all_txt_files:
        ...
        if "8D9T" in file_name:
            ...
            cases = [0, 15, 30, 45, 60, 75, 90]#int(len(data)/num_lines)

...
if __name__ == '__main__':
    ...
    RT = [1.0]
    CL = [0.5]
    hb = [0.25]#np.linspace(0.1, 1.0, 100)[10:20] #if h/b not changing, make sure to change for loop
    d = 0
    t = 4 
    ma = 6
    ...
    x = [ma] + [0]*t + [0]*d
    # x = [7.5204133537751829e+00,
    #      1.0694584991728304e+00,
    #      4.3879873090498128e-01,
    #      1.8936982581104642e-01,
    #      7.7513763155930064e+00,
    #     -3.3073099096395239e+01,
    #     -6.0007389855208757e+01,
    #     -2.8805615946253443e+01,
    #     -4.3417187159490256e+00]

...
cdi.plot(points[:, 0], points[:, 1], color="black", linewidth=plot_linewidth, label=r"$h/b=0.25$")
cdi.plot(oge[:, 0], oge[:, 1], label="Out of Ground Effect", color="black", linewidth=plot_linewidth, linestyle="--")
plt.legend(fontsize=14)
    
fig.savefig("C:/Users/A02247969/Docs/AeroLab/Ground_Effect/New_plots/cl_cdi.pdf", bbox_inches='tight')